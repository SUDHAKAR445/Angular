...
[x: string]: any;
  ...
  totalProductsInStock = this.products.filter(product => product.is_in_inventory === true).length;
  totalProductsOutOfStock = this.products.filter(product => product.is_in_inventory === false).length;
